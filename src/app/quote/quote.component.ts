...
export class QuoteComponent implements OnInit {
  goals:Quote[] = [
    new Quote(1, 'Dwell on the beauty of life', 'Watch the stars, and see yourself running with them.Marcus Aurelius',new Date(2022,3,14)),
    new Quote(2,'Nothing is impossible', 'The word itself says I’m possible! Audrey Hepburn',new Date(2022,6,9)),
